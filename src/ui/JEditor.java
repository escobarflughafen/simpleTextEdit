    ...
    public JEditor() {
        ...
        searchTextField.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                super.keyPressed(e);
                if (e.getKeyChar() == '\n') {
                    editorUtil.searchInRange(textEditorPane.getText(), 0, textEditorPane.getText().length());
                    System.out.println("return Carriage!");
                }
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        autosaveLabel.setHorizontalAlignment(0);
        autosaveLabel.setHorizontalTextPosition(0);
        autosaveLabel.setText("");
        toolBarMidPanel.add(autosaveLabel, BorderLayout.CENTER);
